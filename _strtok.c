...
/**
  * _strtok- This is our custom implementation of the built in strtok() function
  *
...
char* _strtok(char *BUFFER_STR, const char *delims)
{
	...
	/* we use the strpbrk() to find the first occurence of any of the delimiters in str */
